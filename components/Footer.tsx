    ...
    <footer className="bg-[#18153d] text-indigo-300 w-full min-h-screen flex flex-col pt-32 pb-8 px-8 border-t border-white/10 font-sans">
      ...
      <div className="max-w-[1280px] w-full mx-auto grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-12 pb-12">
        <div>
          ...
          <p className="text-indigo-300/80 text-sm max-w-[320px] mt-4 leading-relaxed">
          ...
          <div className="flex gap-3.5 mt-6">
            ...
            <a
              ...
              aria-label="LinkedIn"
              className="w-[36px] h-[36px] rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white/10 hover:border-white/40 transition-all"
            >
        ...
        <div className="flex flex-col">
          <h4 className="font-space text-[12px] font-bold uppercase tracking-widest text-white/90 mb-4">
            Quick Links
          </h4>
          <ul className="list-none space-y-3">
            <li>
              <Link
                href="/"
                className="text-sm text-indigo-300/80 hover:text-white transition-colors"
              >
                Home
              </Link>
            </li>
        ...
        <div className="flex flex-col">
          ...
          <ul className="list-none space-y-3">
            ...
            <li className="text-sm text-indigo-300/80">9am – 5pm (UTC)</li>
          </ul>
        </div>
      </div>
