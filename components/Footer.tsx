      ...
      <div className="max-w-[1160px] mx-auto grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-10 pb-11">
        ...
        <div className="flex flex-col">
          ...
          <ul className="list-none space-y-3">
            ...
            <li><Link href="/#services" className="text-sm text-indigo-300 hover:text-white transition-colors">Services</Link></li>
            <li><Link href="/#work" className="text-sm text-indigo-300 hover:text-white transition-colors">Work</Link></li>
            <li><Link href="/#ladder" className="text-sm text-indigo-300 hover:text-white transition-colors">Work with us</Link></li>
        ...
        <div className="flex flex-col">
          ...
          <ul className="list-none space-y-3">
            ...
            <li><Link href="/case-studies/swiftcart" className="text-sm text-indigo-300 hover:text-white transition-colors">Bultra Bank — Fintech</Link></li>
            <li><Link href="/case-studies" className="text-sm text-indigo-300 hover:text-white transition-colors">AI SaaS</Link></li>
