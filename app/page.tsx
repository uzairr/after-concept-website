          ...
          <div className="max-w-[1160px] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {[
                ...
                { num: '03', price: '$15,000–$50,000', title: 'Full build', desc: 'Embedded team delivery of your product end to end — Discover, Design, Build, and the Scale work after launch.', meta: 'Custom scope · In production', who: 'Founders ready to build and ship, with or without in-house engineers.', cta: 'Start a build' }
              ].map(tier => (
